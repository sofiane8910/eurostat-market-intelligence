...
def load_availability_data():
    """Load availability CSVs generated by deep dive/collect_availability.py."""
    deep_dive_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "deep dive")
    summary_path = os.path.join(deep_dive_dir, "availability_summary.csv")
    detail_path = os.path.join(deep_dive_dir, "availability_detail.csv")
